...
#func target_in_range()->bool:
	#return Entities.arena.grid.cell_distance(position, target.position) <= skill_range 
#
#func _on_refresh_target_timeout() -> void:
	#print(Entities.arena.grid.cell_distance(position, target.position), current_cell)
