...
const tooltips = {
	"charisma":
		"Charisma improves your trading skills, the rate at which your relations improve and your ability to [b]convince[/b] people.",
	"navigation":
	...
	"leadership":
		"Leadership improves the [b]units in your party[/b], making them [b]level up faster[/b] and imrpoving their resource efficiency.",
	"scavenging":
