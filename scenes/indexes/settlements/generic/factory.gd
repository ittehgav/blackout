...
var description: String = "Produces and trades mostly" + Index.get_color_tag("fuel") + " Fuel[/color],"+Index.get_color_tag("juice") + " Juice[/color] and"+Index.get_color_tag("scrap") + " Scrap.[/color]";
