...
@onready var description:String = "Consumes " + str(scrap_cost) + Index.resource_colored_name("scrap") + " and"\
			+Index.get_color_tag("shield") + " shields[/color] you and nearby allies for 20% of your " + Index.stat_colored_name("max_hp") + ".";
...
func use()->void:
	...
	var shield_value:float = Entities.in_fight_player.max_hp/2;
