...
func full_skill_description(unit:FighterUnit)->String:
	...
	var final_string:String = r"Deals damage to enemies in front of him and sends them flying a short distance, heals himself for %s % of the damage dealt."%percentage_str
	return final_string;
