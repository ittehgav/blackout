...
const profile = {
	"skill_name": "Chain Lightning",
	"short_description": "Fires Chain Lightning Attacks.",
	"long_description": "Magnetizes one enemy, then deals damage to all magnetized enemies.\nDeals more damage the more magnetized enemies there are."
}
